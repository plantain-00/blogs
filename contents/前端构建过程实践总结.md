...
这时`index.bundle.js`取代`index.js`，成为js的入口文件，`index.ejs.html`、`rev-static.config.json`中都有做相应的更新。
...
这时`index.bundle.css`取代`index.css`，成为css的入口文件，`index.ejs.html`、`rev-static.config.json`中都有做相应的更新。
